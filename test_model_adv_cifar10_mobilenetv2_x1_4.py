...
# Tính chỉ số SSIM sử dụng hàm tích hợp trong PyTorch
            ...
            print(f"L0 score: {l0}","   id  ",count)
            print(f"L1 score: {l1}","   id  ",count)
            print(f"L2 score: {l2}","   id  ",count)

            sl0 += l0
            sl1 += l1
            sl2 += l2
       
            print("Sum L0 L1 L2 LP-NORM : ", sl0," -- ", sl1," -- ", sl2 )
            print("Sum SPSNR: ", spsnr)
            sssim += ssim_score
            print("Sum SSSIM: ", sssim)
        print('SSIM: TB ',sssim/count) 
        print('PSNR: TB ',spsnr/count) 
        print("AVG L0 L1 L2 LP-NORM : ", sl0/count," -- ", sl1/count," -- ", sl2/count ," -- ")    
